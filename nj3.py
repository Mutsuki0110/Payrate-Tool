...
emec_file = f'nj3_plain_records/EMEC JDL NJ3 {date}.xlsx'
gs_file = f'nj3_plain_records/GS JDL NJ3 {date}.xlsx'
osi_file = f'nj3_plain_records/OSI JDL NJ3 {date}.xlsx'
wfe_file = f'nj3_plain_records/WFE JDL NJ3 {date}.xlsx'
...
combined_df = pd.concat([emec, gs, osi, wfe], ignore_index=True)
...
# Add a new column "Building" with the value "NJ3"
combined_df.insert(0, 'Building', 'NJ3')
...
output_file = f'outputs/NJ3 {date}.xlsx'
