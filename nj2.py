...
emec_file = f'nj2_plain_records/EMEC JDL NJ2 {date}.xlsx'
osi_file = f'nj2_plain_records/OSI JDL NJ2 {date}.xlsx'
wfe_file = f'nj2_plain_records/WFE JDL NJ2 {date}.xlsx'
...
# Add a new column "Building" with the value "NJ2"
combined_df.insert(0, 'Building', 'NJ2')
...
output_file = f'outputs/NJ2 {date}.xlsx'
